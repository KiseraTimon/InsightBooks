...
class Default:
    ...
    MAIL_USE_TLS = env_bool("MAIL_USE_TLS")
    MAIL_USE_SSL = env_bool("MAIL_USE_SSL")
    MAIL_USERNAME = os.getenv("MAIL_USERNAME")
    MAIL_PASSWORD = os.getenv("MAIL_PASSWORD")
    MAIL_DEFAULT_SENDER = os.getenv("MAIL_DEFAULT_SENDER")
    MAIL_ASCII_ATTACHMENTS = env_bool("MAIL_ASCII_ATTACHMENTS")
    _max_emails = os.getenv("MAIL_MAX_EMAILS")
    MAIL_MAX_EMAILS = int(_max_emails) if _max_emails and _max_emails.isdigit() else None
